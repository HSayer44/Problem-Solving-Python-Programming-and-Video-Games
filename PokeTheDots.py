...
from pygame import QUIT, Color, MOUSEBUTTONUP, KEYDOWN, K_p, K_q
...
class Game:
    ...
    def handle_one_event(self, event):
        ...
        elif event.type == MOUSEBUTTONUP or (event.type == KEYDOWN and event.key == K_p):
